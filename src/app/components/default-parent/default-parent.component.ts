...
@Component({
  ...
  template: `
    <div class="parent default-parent">
      <h2>默认变更检测父组件</h2>
...
export class DefaultParentComponent implements OnInit, DoCheck, OnChanges {
  newText = '';
  newItem = '';
  state: any;
  ...
  ngOnInit(): void {
    ...
    console.count('DefaultParentComponent.ngOnInit');
  }

  ngOnChanges(changes: SimpleChanges): void {
    console.count('DefaultParentComponent.ngOnChanges');
  }

  ngDoCheck(): void {
    console.count('DefaultParentComponent.ngDoCheck');
  }
  ...
  get expensiveCounter(): number {
    ...
    console.count('DefaultParentComponent.expensiveCounter');
  ...
  get expensiveText(): string {
    ...
    console.count('DefaultParentComponent.expensiveText');
  ...
  get expensiveItemsCalculation(): number {
    ...
    console.count('DefaultParentComponent.expensiveItemsCalculation');
